...
public class GPSDec2Deg extends Form implements CommandListener{
	...
	public GPSDec2Deg(String title,UIController control){
		super(title);
    	controller=control;
    	...
    	DecField=new TextField("d.dddddd","",10,TextField.DECIMAL);
    ...
    private void CalAlert(String dec){
        ...
        String message = degree.elementAt(0)+"°"+degree.elementAt(1)+"'"+degree.elementAt(2)+"\""
        		+"\nRadians is "+dnum;
