...
public class GPSDegm2Deg extends Form implements CommandListener{
	...
	public GPSDegm2Deg(String title,UIController control){
		super(title);
    	controller=control;
    ...
    private void CalAlert(String d, String m){
        ...
        Vector degm = gpscalfun.degm2deg(d, m);
        double ddegm = gpscalfun.degm2dec(d, m);
        double dnum = gpscalfun.Deg2Rad(ddegm) ;
        String message = degm.elementAt(0)+"°"+degm.elementAt(1)+"'"+degm.elementAt(2)+"\""
        		+"\nRadians is "+dnum;
